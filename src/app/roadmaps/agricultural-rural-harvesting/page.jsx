...
import { Map, Waves, TrendingUp, Droplets, Home, Wrench } from 'lucide-react';

export default function AgriculturalRuralRoadmap() {
  const steps = [
    {
      id: 1,
      title: 'Contour Mapping',
      description: 'Identify natural slopes for water flow control.',
      icon: Map,
    ...
    },
    {
      id: 2,
      title: 'Farm Ponds',
      description: 'Excavate ponds to store seasonal rainwater for irrigation.',
      icon: Waves,
      position: { top: '26%', left: '50%' }
    },
    {
      id: 3,
      title: 'Bunds & Trenches',
      description: 'Create barriers to slow down water and increase absorption.',
      icon: TrendingUp,
      position: { top: '42%', left: '50%' }
    },
    {
      id: 4,
      title: 'Field Recharge Pits',
      description: 'Collect runoff directly from fields into recharge structures.',
      icon: Droplets,
      position: { top: '58%', left: '50%' }
    },
    {
      id: 5,
      title: 'Roof Harvesting in Villages',
      description: 'Use tin/asbestos roofs to collect water for livestock.',
      icon: Home,
    ...
    },
    {
      ...
      description: 'Clean pits and reinforce bunds before monsoon.',
      icon: Wrench,
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('/image/Agricultural&RuralHarvesting.png')",
        ...
        <div className="max-w-7xl mx-auto mb-16">
          <div className="text-center mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Agricultural & Rural Harvesting
            </h1>
            <p className="text-xl text-blue-200 max-w-3xl mx-auto">
              Low-cost rainwater storage and field-level solutions designed for farms and rural households.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto mt-24">
          <div className="bg-gradient-to-r from-blue-500/30 to-blue-600/30 backdrop-blur-md rounded-2xl p-10 border-2 border-blue-500/40 shadow-2xl text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Ready to Boost Farm Productivity?
            </h2>
            <p className="text-blue-200 text-lg mb-8 max-w-2xl mx-auto">
              Implement low-cost rainwater harvesting solutions for sustainable agriculture and rural water security.
            </p>
