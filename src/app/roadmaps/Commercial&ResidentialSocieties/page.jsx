...
export default function CommercialRoadmap() {
  const steps = [
    {
      id: 1,
      title: 'Survey Building Roof & Terrace',
      description: 'Calculate total catchment area.',
      icon: Building2,
      position: { top: '10%', left: '50%' }
    },
    {
      id: 2,
      title: 'Centralized Drainage Setup',
      description: 'Combine all downpipes into a single collection pipeline.',
      icon: Workflow,
      position: { top: '26%', left: '50%' }
    },
    {
      id: 3,
      title: 'First-Flush System',
      description: 'Install a mechanism to discard initial dirty runoff.',
      icon: Droplet,
      position: { top: '42%', left: '50%' }
    },
    {
      id: 4,
      title: 'Construct Large Storage Tanks',
      description: 'Ground-level or underground reinforced tanks.',
      icon: Database,
    ...
    },
    {
      ...
      description: 'Multi-layer filtration for greywater or irrigation usage.',
      icon: Filter,
      position: { top: '74%', left: '50%' }
    },
    {
      id: 6,
      title: 'Reuse Integration',
      description: 'Connect to landscape irrigation, flushing systems, or cleaning use.',
      icon: Recycle,
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('/image/Commercial&ResidentialSocieties.png')",
        ...
        <div className="max-w-7xl mx-auto mb-16">
          <div className="text-center mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Commercial & Residential Societies
            </h1>
            <p className="text-xl text-blue-200 max-w-3xl mx-auto">
              Medium-scale systems for apartments, offices, and commercial buildings that generate higher runoff.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto mt-24">
          <div className="bg-gradient-to-r from-blue-500/30 to-blue-600/30 backdrop-blur-md rounded-2xl p-10 border-2 border-blue-500/40 shadow-2xl text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Ready to Implement at Your Society?
            </h2>
            <p className="text-blue-200 text-lg mb-8 max-w-2xl mx-auto">
              Scale up water conservation with our medium-scale rainwater harvesting solutions.
            </p>
