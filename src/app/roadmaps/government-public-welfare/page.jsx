...
import { BarChart3, Dam, Droplet, School, GraduationCap, ClipboardCheck } from 'lucide-react';

export default function GovernmentWelfareRoadmap() {
  const steps = [
    {
      id: 1,
      title: 'Hydrological Survey',
      description: 'Identify water-stressed areas and groundwater levels.',
      icon: BarChart3,
      position: { top: '10%', left: '50%' }
    },
    {
      id: 2,
      title: 'Build Check Dams',
      description: 'Small barriers on drains and streams to store monsoon water.',
      icon: Dam,
      position: { top: '26%', left: '50%' }
    },
    {
      id: 3,
      title: 'Construct Recharge Wells',
      description: 'Deep wells that inject water directly into aquifers.',
      icon: Droplet,
      position: { top: '42%', left: '50%' }
    },
    {
      id: 4,
      title: 'School & Panchayat Harvesting Units',
      description: 'Install rooftop systems on public buildings.',
      icon: School,
      position: { top: '58%', left: '50%' }
    },
    {
      id: 5,
      title: 'Community Training Drives',
      description: 'Educate citizens on maintaining structures.',
      icon: GraduationCap,
      position: { top: '74%', left: '50%' }
    },
    {
      id: 6,
      title: 'Monitoring & Annual Audit',
      description: 'Government teams track water table improvements.',
      icon: ClipboardCheck,
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div 
        ...
        style={{
          backgroundImage: "url('/image/Government&PublicWelfareProjects.png')",
        ...
        <div className="max-w-7xl mx-auto mb-16">
          <div className="text-center mb-4">
            ...
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-4">
              Government & Public Welfare Projects
            </h1>
            <p className="text-xl text-blue-200 max-w-3xl mx-auto">
              Large-scale systems implemented at village, town, or city levels for water security and recharge.
            </p>
          </div>
        </div>
        ...
        <div className="max-w-4xl mx-auto mt-24">
          <div className="bg-gradient-to-r from-blue-500/30 to-blue-600/30 backdrop-blur-md rounded-2xl p-10 border-2 border-blue-500/40 shadow-2xl text-center">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
              Ready to Transform Water Security?
            </h2>
            <p className="text-blue-200 text-lg mb-8 max-w-2xl mx-auto">
              Implement large-scale water harvesting solutions for sustainable community development and groundwater recharge.
            </p>
